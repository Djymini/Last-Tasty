...
import { PixelMapIcon } from "@/components/ui/plans/PixelMapIcon";
...
export function ManorMapHUDButton() {
    ...
    return (
        <button
            ...
            onClick={toggleMap}
            className={
                "fixed top-4 right-4 z-[60] size-16 " +
                "bg-stone-800 border-4 border-stone-600 " +
            ...
            title="Plans du manoir"
        >
            <PixelMapIcon size={28} />
        </button>
    );
}
